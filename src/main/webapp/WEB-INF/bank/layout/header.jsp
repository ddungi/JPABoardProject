		...
		<div class="container-fluid">
			...
			<c:if test="${principal == null }">
				<ul class="navbar-nav me-auto">
					...
					<li class="nav-item"><a class="nav-link" href="/auth/user">회원가입</a></li>
				</ul>
			</c:if>
			<c:if test="${principal != null }">
				<ul class="navbar-nav me-auto">
					<li class="nav-item"><a class="nav-link" href="/user/${principal.getUser().username}">회원상세</a></li>
					<li class="nav-item"><a class="nav-link" href="/post">1:1문의</a></li>
